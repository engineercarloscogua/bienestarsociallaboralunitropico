...
function icon(string $name, string $class = '', int $size = 24): string {
    $icons = [
        ...
        'eye-off'        => '<svg xmlns="http://www.w3.org/2000/svg" width="'.$size.'" height="'.$size.'" class="'.$class.'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m2 2 20 20"/><path d="M6.71 6.71C4.6 8.1 3.15 10 2 12c2.73 4.67 6.07 7 10 7 1.38 0 2.67-.29 3.87-.87"/><path d="M10.73 5.08A9.4 9.4 0 0 1 12 5c3.93 0 7.27 2.33 10 7a16.2 16.2 0 0 1-2.12 2.93"/><path d="M14.12 14.12A3 3 0 0 1 9.88 9.88"/></svg>',
        'eye'            => '<svg xmlns="http://www.w3.org/2000/svg" width="'.$size.'" height="'.$size.'" class="'.$class.'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12Z"/><circle cx="12" cy="12" r="3"/></svg>',
        'upload'         => '<svg xmlns="http://www.w3.org/2000/svg" width="'.$size.'" height="'.$size.'" class="'.$class.'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 16V3m0 0-4 4m4-4 4 4"/><path d="M3 16v4a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-4"/></svg>',
        'download'       => '<svg xmlns="http://www.w3.org/2000/svg" width="'.$size.'" height="'.$size.'" class="'.$class.'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v13m0 0-4-4m4 4 4-4"/><path d="M3 17v3a1 1 0 0 0 1 1h16a1 1 0 0 0 1-1v-3"/></svg>',
        'search'         => '<svg xmlns="http://www.w3.org/2000/svg" width="'.$size.'" height="'.$size.'" class="'.$class.'" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>',
